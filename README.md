...
[![codecov](https://app.codecov.io/gh/ropensci/occCite/branch/main/graph/badge.svg?token=01yJEEIEQN)](https://app.codecov.io/gh/ropensci/occCite)
...
```
    ...
    ## https://doi.org/10.5281/zenodo.4726676), R package version 0.6.2,
