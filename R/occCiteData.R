...
#'
#' @slot occSources A vector of class "character" containing a list of occurrence data sources, generated when passing a \code{\link{occCiteData}} object through \code{\link{taxaQuery}}.
#'
