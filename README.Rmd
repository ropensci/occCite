...
occCite also contains tools to plot search results. We can pass a single-species search occCite object to be mapped using `leaflet`.
```{r mapping search results, eval = T, echo = T}
