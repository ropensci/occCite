...
occCite also contains tools to plot search results. We can pass a single-species search occCite object to be mapped as an interactive html widget using `leaflet`.
