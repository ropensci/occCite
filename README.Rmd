...
occCite includes a `plot` method for `occCiteData` objects, which is capable of generating three types of plots. First, let's see how the results of our multiple species query looks.
