---
title: "An overview of executing searches and generating citations using occCite"
author:
- Hannah L. Owens
- Cory Merow
- Brian Maitner
...
```{r plotting all species, eval=T, message=FALSE, warning=FALSE, paged.print=FALSE, results='hide', fig.hold='hold', out.width="33%"}
plot(myPhyOccCiteObject)
```

*or* you can plot the results by species!

```{r plotting phylogenetic search by species, eval=T, message=FALSE, warning=FALSE, paged.print=FALSE, results='hide', fig.hold='hold', out.width="33%"}
