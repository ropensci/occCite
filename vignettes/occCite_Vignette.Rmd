...
#Query databases for names
myOccCiteObject <- studyTaxonList(x = "Protea cynaroides", datasources = "NCBI");
...
Getting citation works the exact same way with previously-downloaded data as it does from a fresh dataset.
...
Note that you can also load multiple species using either a vector of species names or a phylogeny (provided you have previously downloaded data for all of the species of interest), and you can load occurrences from non-GBIF datasources in the same query.
